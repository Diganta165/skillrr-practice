  ...
  >
    <div class="skiller_sign_in_wrapper">
      ...
      <div class="skiller_form_wrapper">
        ...
        <form action="" class="skiller_form" @submit.prevent="submitRegister()">
...
export default {
    ...
    emailValidation() {
      if (this.userData.email.length != 0) {
        ...
        if (
          ...
          this.userData.msg = "Please Enter a Valid Email";
  ...
  mounted() {
    axios.get("http://192.168.0.132:8080/api/v1/country").then((res) => {
      ...
      this.countryLists = res.data.data;
      console.log("This is countryList", this.countryLists);
    });
  },
};
</script>
